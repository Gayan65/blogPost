            ...
            <div className="container my-auto">
                ...
                <main className="form-signin w-100 mx-auto">
                    <form method="POST" onSubmit={handleLogin}>
                        ...
                        <div className="form-floating">
                            <input type="password" className="form-control mb-3 input-custom-css" id="floatingPassword" placeholder="Password" onChange={e => setPassword(e.target.value)} name="password" value={password} required/>
